    ...
    <section className="py-24 bg-slate-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-primary font-semibold tracking-wider uppercase text-sm">Our Reach</span>
        ...
        <div className="relative w-full max-w-4xl mx-auto aspect-[4/3] md:aspect-[16/9] bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden">
          ...
          {locations.map((loc) => (
            ...
            >
              {/* Pulse Effect */}
              <div className="absolute inset-0 bg-secondary rounded-full animate-ping opacity-75 w-full h-full"></div>
              
              {/* Pin Icon */}
              <div className="relative bg-primary text-white p-2 rounded-full shadow-lg group-hover:bg-secondary transition-colors z-10">
          ...
          <AnimatePresence mode="wait">
            {activeLocation && (
              <motion.div
                ...
                className="absolute bottom-6 left-6 right-6 md:left-auto md:right-6 md:w-80 bg-white/90 backdrop-blur-md border border-slate-200 p-6 rounded-2xl shadow-2xl z-20"
              >
                <button 
                ...
                <div className="text-primary font-bold text-sm mb-3 uppercase tracking-wide">
