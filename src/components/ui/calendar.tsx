  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today: "bg-blue-100 text-slate-900",
        day_outside:
          "day-outside text-slate-500 opacity-50 aria-selected:bg-blue-100/50 aria-selected:text-slate-500 aria-selected:opacity-30",
